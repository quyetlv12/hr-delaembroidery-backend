...
export const updateEmployeeTimekeepingCodeDto = z.object({
  timekeepingCode: z
    .preprocess((value) => (value === "" ? null : value), z.string().trim().max(50).nullable())
    .optional(),
});
...
export type UpdateEmployeeTimekeepingCodeDto = z.infer<typeof updateEmployeeTimekeepingCodeDto>;
